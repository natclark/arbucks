...
<nav>
    <div class="container">
        ...
        <div class="right">
            ...
            <a href="https://t.me/arbucksmidnight" title="Telegram" draggable="false" rel="external noopener" target="_blank" on:mousedown={(e) => ripple(e, doc)} on:click={(e) => ripple(e, doc)}>
