    ...
    <div class="container">
        ...
        <div class="right">
            ...
            <button title="Change Theme">
                <svg version="1.1" width="24px" height="24px" x="0px" y="0px" viewBox="0 0 122.88 122.88" style="enable-background:new 0 0 122.88 122.88" xml:space="preserve" on:mousedown={(e) => ripple(e, doc)} on:click={changeTheme}>
                    <g>
            ...
            <a href="https://twitter.com/arbucks_io" title="Twitter" draggable="false" rel="external noopener" target="_blank" on:mousedown={(e) => ripple(e, doc)} on:click={(e) => ripple(e, doc)}>
