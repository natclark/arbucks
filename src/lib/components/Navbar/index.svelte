...
<nav>
    <div class="container">
        <div class="left">
            <a href="/" title="Home" draggable="false" on:mousedown={(e) => ripple(e, doc)} on:click={(e) => ripple(e, doc)} sveltekit:prefetch>
            ...
            <a href="/pairs/" draggable="false" on:mousedown={(e)=> ripple(e, doc)} on:click={(e) => ripple(e, doc)} sveltekit:prefetch>Pairs</a>
        ...
        <div class="right">
            <a href="https://github.com/natclark/arbucks" title="GitHub" draggable="false" on:mousedown={(e) => ripple(e, doc)} on:click={(e) => ripple(e, doc)}>
            ...
            <a href="https://t.me/arbuckscafe" title="Telegram" draggable="false" on:mousedown={(e) => ripple(e, doc)} on:click={(e) => ripple(e, doc)}>
